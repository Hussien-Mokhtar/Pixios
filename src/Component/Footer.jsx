        ...
        <>
            ...
            <div className="contain">
                <div className="footer">
                        ...
                        <Row>
                            <Col sm={3} className='footer-1'><img src={logo} alt="" /><br /><br />
                            ...
                            <Col sm={2}>                         <p className='p-title-footer'>Our Stores</p>
                                <p>New York <br /><br />London SF <br /><br />Edinburgh <br /><br />Los Angeles <br /><br />Chicago<br /> <br />Las Vegas</p>
                            </Col>
                            <Col sm={2}>                        <p className='p-title-footer'>Useful Links</p>
                                <p>Privacy Policy <br /><br />Returns <br /><br />Terms & Conditions <br /><br />Contact Us <br /><br />Latest News<br /> <br />Our Sitemap</p>
                            </Col>
                            <Col sm={2}>                         <p className='p-title-footer'>Footer Menu</p>
