          ...
          <div className="flex align-items-center justify-content-center">
            <div className="surface-card p-4 shadow-2 border-round w-full lg:w-6">
              <div className="text-center mb-5">
                <div className="text-900 text-3xl font-medium mb-3"><h1 >Login</h1></div>
              ...
              <div>
                ...
                <div className="flex align-items-center justify-content-between mb-6">
                  ...
                  <a className="font-medium no-underline ml-2 text-blue-500 text-right cursor-pointer" style={{ color: "rgb(220, 51, 82)", fontWeight: "700", cursor: "pointer" }}>Forgot your password?</a>
                </div>
